...
Connects to the [ai-chatbot backend](https://github.com/YOUR_USERNAME/ai-chatbot) for real-time chat and analytics.
...
Backend repo: [ai-chatbot](https://github.com/YOUR_USERNAME/ai-chatbot)
